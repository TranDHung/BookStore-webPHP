...
<body>
  ...
  <div class="row-header">
    <div class="cell">Tên sách</div>
    <div class="cell">Nhà xuất bản</div>
    <div class="cell">Nhà cung cấp</div>
    <div class="cell">Tác giả</div>
  ...
  <div class="row">
  <?php
    $result = getBookInforMana($_SESSION['vitri']);
    ...
    <div class="cell"><?= $row['tensach'] ?></div>
    <div class="cell"><?= $row['nxb'] ?></div>
    <div class="cell"><?= $row['nhacungcap'] ?></div>
    <div class="cell"><?= $row['tacgia'] ?></div>
    <div class="cell"><?= $row['giasach'] ?></div>
    <div class="cell-icon"><button type="submit" style="background-color:white; border: none;" name="editConfirm" value="<?= $row['masach'] ?>"><span class="fa fa-wrench"></span></button></div>
    <div class="cell-icon"><button onclick="return confirm('Bạn có chắc chắn muốn xóa?')" type="submit" style="background-color:white; border: none;" name="deleteConfirm" value="<?= $row['masach'] ?>"><span class="fa fa-close" style="color: red"></span></button></div>
  </div>
...
<div class="circle"><a href="add_Book.php"><span class="fa fa-plus"></span></a></div>
