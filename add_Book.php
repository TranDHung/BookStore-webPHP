  ...
  <?php
    ...
    if(isset($_POST['ma']) && isset($_POST['ten']) &&  isset($_POST['gia']) && isset($_POST['nxb']) && isset($_POST['ncc']) && isset($_POST['vitri']) && isset($_POST['anh']) && isset($_POST['bia']) && isset($_POST['tacgia'])) {
        ...
        //echo $ten;
            ...
            // change password
            $result = addBookInfor($ma,$ten,$gia,$nxb,$ncc,$vitri,$anh,$bia,$tacgia);
           if ($result['code'] == 0){
...
<body>
  <nav class="navbar navbar-expand-sm navbar-infor">
    ...
    <div class="text-create">Thêm sách</div>
    ...
    <div class="field">
      <span>Ảnh: </span>
      <input name="anh" id="picture" type="file" style="padding-left: 90px; ">
    </div>
    <div class="field">
      <span>Hình thức bìa: </span>
      <input type="text" name="bia" class="form-control">
    </div>
    <div class="field">
      <span>Tác giả: </span>
    ...
    <button class="create-btn" type="submit" name="update">Thêm sách</button>
