  ...
  <?php
    ...
    if(isset($_POST['manv']) &&  isset($_POST['tennv']) && isset($_POST['gioitinh']) && isset($_POST['ngaysinh']) && isset($_POST['vitri']) && isset($_POST['chucvu'])){
        ...
        if (empty($ten )) {
            ...
            // change password
            $result = addCustom($ma,$ten,$gioi,$ngays,$vitri,$chucvu);
           if ($result['code'] == 0){
...
<body>
  <nav class="navbar navbar-expand-sm navbar-infor">
    ...
    <div class="text-create">Thêm nhân viên</div>
    ...
    <button class="create-btn" type="submit" name="update" style="width: 90px;">Thêm</button>
