...
<body>
  ...
  <?php
    ...
    <div class="cell"><?= $row['tendangnhap'] ?></div>
    <div class="cell"><?= $row['hoten'] ?></div>
    <div class="cell"><?= $row['ngaysinh'] ?></div>
    <div class="cell"><?= $row['sdt'] ?></div>
    <div class="cell"><?= $row['type'] ?></div>
    <div class="cell-icon"><button type="submit" style="background-color:white; border: none;" name="editConfirm" value="<?= $row['tendangnhap'] ?>"><span class="fa fa-wrench"></span></button></div>
    <div class="cell-icon"><button onclick="return confirm('Bạn có chắc chắn muốn xóa?')" type="submit" style="background-color:white; border: none;" name="deleteConfirm" value="<?= $row['tendangnhap'] ?>"><span class="fa fa-close" style="color: red"></span></button></div>
  </div>
...
<div class="circle"><a href="add_Account.php"><span class="fa fa-plus"></span></a></div>
